...
# Licence
This application and all the source code is release under licence LGPL 3.0.
...
All protocols are analysed by reverse engineering on territory of France, by observation of network packet traffic and without any decompilation of code, in order to aim of system interoperability.
